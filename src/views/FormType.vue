    ...
    <b-form-group>
      <b-row>
        ...
        <b-col>
          ...
          <b-form-radio v-model="selected" name="some-radios" value="B" disabled>範本一</b-form-radio>
        </b-col>

        <b-col>
          <b-img v-bind="mainProps" blank-color="#777" alt="img3"></b-img>
          <b-form-radio v-model="selected" name="some-radios" value="C" disabled>範本二</b-form-radio>
        </b-col>
      </b-row>
     </b-form-group>
