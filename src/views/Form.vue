<template>
  <div id="bg">
    <b-container fluid class="bv-example-row">
      ...
      <b-row>
        <b-col lg="2">
          <b-button variant="primary" id="save-download" @click="postform()"
            >儲存並下載</b-button
          >
        </b-col>
        <b-col>
...
export default {
  ...
  computed: {
    Customer_ID_State() {
      if (this.Customer.Customer_ID.length == 0) return null;
      else return this.Customer.Customer_ID.length == 8 ? null : false;
    },
