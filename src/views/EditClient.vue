  ...
  <div id="bg">
    <b-container fluid class="bv-example-row">
      ...
      <b-row>
        ...
        <b-col>
          <b-button variant="outline-primary" id="console" @click="cancel()">取消</b-button>
        </b-col>
      </b-row>
    </b-container>
  </div>
...
export default {
  ...
  methods: {
    customerfinish() {
      ...
      this.$api.PutCustomerEdit(this.items.CustomerID,Customer)
        .then(function () {
          alert("修改成功");
  ...
  mounted() {
    ...
    const that = this;
    this.$api.GetCustomerEdit(this.items.CustomerID)
